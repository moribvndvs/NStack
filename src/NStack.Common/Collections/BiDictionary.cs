...
namespace NStack.Collections
{
    ...
    /// </summary>
    /// <remarks>
    ///     When used as a normal dictionary (as <see cref="IDictionary{TKey,TValue}" /> ), the key type is
    ///     <typeparamref
    ///         name="TLeft" />
    ///     and the value type is <typeparamref name="TRight" />
    /// </remarks>
    ...
    public class BiDictionary<TLeft, TRight> : IDictionary<TLeft, TRight>
    {
        ...
        /// <summary>
        ///     Gets the key side of bidirectional dictionary, where the key is <typeparamref name="TLeft" /> and the value is
        ///     <typeparamref
        ///         name="TRight" />
        ///     .
        /// </summary>
        ...
        /// <summary>
        ///     Gets the value side of the bidirectional dictionary, where the key is <typeparamref name="TRight" /> and the value is
        ///     <typeparamref
        ///         name="TLeft" />
        ///     .
        /// </summary>
        ...
        /// <param name="value"> The value. </param>
        /// <param name="key">
        ///     When the method returns and the value found in the dictionary, the key will be the key associated with the specified value. Otherwise, key will be set to the default value of
        ///     <typeparamref
        ///         name="TLeft" />
        ///     .
        /// </param>
